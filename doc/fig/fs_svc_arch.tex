...
image(
	...
	draw txtFrameDashed(6u, 1.5v, btex \mplabel{上下文} etex) shifted (0, -3v);
	draw txtFrame(4u, 1.5v, btex \mplabel{设备...} etex) shifted (-3u, -6v);
	draw txtFrame(4u, 1.5v, btex \mplabel{配置数据} etex) shifted (3u, -6v);

	draw itemArrow((-4u,-5.5v), (-4u,2.5v));	% device -> controller
	draw itemArrow((4u,2.5v), (4u,-5.5v));		% controller -> cfg
	...
	draw itemArrow((u,-0.5v), (2u,-5.5v));		% controller -> sm
)
enddef;


draw itemSvc(btex \mplabel{业\\务\\N} etex) shifted (-8u, v);
