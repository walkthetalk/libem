...
void pqxx::internal::params::add_field(const sys_cfg & src)
{
	...
	add_field(src.iaparam.winx_width);
	add_field(src.iaparam.winx_height);
	add_field(src.iaparam.winx_left);
	add_field(src.iaparam.winx_top);
	add_field(src.iaparam.winy_width);
	add_field(src.iaparam.winy_height);
	add_field(src.iaparam.winy_left);
	add_field(src.iaparam.winy_top);
...
pqxx::const_row_iterator pqxx2c(sys_cfg & dst, const pqxx::const_row_iterator & src)
{
	...
	pqxx2c(dst.iaparam.winx_width, it); ++it;
	pqxx2c(dst.iaparam.winx_height, it); ++it;
	pqxx2c(dst.iaparam.winx_left, it); ++it;
	pqxx2c(dst.iaparam.winx_top, it); ++it;
	pqxx2c(dst.iaparam.winy_width, it); ++it;
	pqxx2c(dst.iaparam.winy_height, it); ++it;
	pqxx2c(dst.iaparam.winy_left, it); ++it;
	pqxx2c(dst.iaparam.winy_top, it); ++it;
