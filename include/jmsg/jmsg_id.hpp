...
enum class mid_t : uint16_t {
	...
	lcd_power_ctl = 34,
	llvl_request = 35,
	loss_estimating_result = 36,
	manual_arc_result = 37,
	motorTestResult = 38,
	motorTestStart = 39,
	process_progress = 40,
	queryBatState = 41,
	...
	set_motor_speed = 55,
	set_multi_stream = 56,
	set_single_stream = 57,
	shutdown = 58,
	skip = 59,
	stabilizeElectrodeResult = 60,
	stabilizeElectrodeStart = 61,
	startDustCheckFull = 62,
	start_motor = 63,
	stop = 64,
	stopDischarge = 65,
	stop_motor = 66,
	tenseTestResult = 67,
	update_led_brightness = 68,
	update_window_position = 69,
};
template<mid_t mid>
